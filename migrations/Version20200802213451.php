 ...
 */
final class Version20200802213451 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE "user" ADD delivery_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_8D93D64912136921');
        $this->addSql('ALTER TABLE "user" DROP delivery_id');
    }
}
