 ...
 */
final class Version20200808092015 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE command (id INT NOT NULL, delivery_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, items INT NOT NULL, PRIMARY KEY(id))');
