 ...
 */
final class Version20200908224700 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE command (id INT NOT NULL, email VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, price INT DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, comment TEXT DEFAULT NULL, details TEXT NOT NULL, reference VARCHAR(255) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, command_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE delivery (id INT NOT NULL, city_id INT NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE meal (id INT NOT NULL, provider_id INT NOT NULL, menu_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, recipe TEXT DEFAULT NULL, picture TEXT DEFAULT NULL, description TEXT DEFAULT NULL, price INT NOT NULL, slug VARCHAR(255) NOT NULL, img VARCHAR(255) NOT NULL, img_info TEXT NOT NULL, totalcommand INT DEFAULT NULL, delivery BOOLEAN DEFAULT NULL, bitly TEXT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE provider (id INT NOT NULL, city_id INT NOT NULL, name VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, url VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, opentime TIMESTAMP(0) WITH TIME ZONE NOT NULL, closetime TIMESTAMP(0) WITH TIME ZONE NOT NULL, slug VARCHAR(255) NOT NULL, bg_img VARCHAR(255) DEFAULT NULL, linkfb VARCHAR(255) DEFAULT NULL, linkinsta VARCHAR(255) DEFAULT NULL, linktwitter VARCHAR(255) DEFAULT NULL, img_info TEXT DEFAULT NULL, label TEXT DEFAULT NULL, description TEXT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, provider_id INT DEFAULT NULL, delivery_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, slug VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, roles TEXT NOT NULL, salt VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, ntahiti VARCHAR(255) NOT NULL, confirmation_email VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
